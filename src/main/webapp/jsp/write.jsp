...
<body>
	...
	<div>
		...
		<p class="font-weight-bold">Добавить цветок в список</p>
		<input class="mt-2 rounded" id="name" type="text" placeholder="Сорт">
		<input class="mt-2 rounded" id="main_color" type="text" placeholder="Цвет">
		<input class="mt-2 rounded" id="family" type="text" placeholder="Род">
		<input class="mt-2 rounded" id="height" type="number" placeholder="Высота">
		<input class="mt-2 rounded" id="price" type="number" placeholder="Цена">
